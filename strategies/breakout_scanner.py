# strategies/breakout_scanner.py — v14A with Subscription Capacity Management (FIXED)
import logging
import math
import time
...
class BreakoutScanner:
    ...
    Features:
    - ATR breakout: price breaks prior high/low by k*ATR
    - Volume surge: current volume > volume_sma * v_mult
    - EMA trend: EMA8 > EMA21 for longs, reverse for shorts
    - MFI threshold: optional money flow confirmation
    - Respects 50-subscription IB limit
    """
    ...
    def __init__(self, ib, market_bus, 
        ...
        # Capacity tracking
        self._last_universe_symbols: Set[str] = set()
        self._universe_update_cooldown = 10  # Don't spam updates
        self._last_universe_update = 0
        
    def update_universe(self, symbols_or_contracts, position_symbols: Set[str] = None):
        """
    ...
    def tick(self, symbol: str, price: float):
        """Update internal bar data on price tick."""
    ...
    def scan(self, position_symbols: Set[str] = None) -> List[Dict]:
        """
